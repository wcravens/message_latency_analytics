...
- [ ] Interogate the stats on the number of message 'stacks' that we have with duplicate arrival times.
- [ ] Offset message arrival time for duplicate arrival times.
...
- [ ] ?Should 'type' be converted to a factor?
